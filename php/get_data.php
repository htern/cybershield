...
/*$sFilename = '../data/effective_data.csv';*/

// get stat number (ID)
$i = (int)$_GET['id'];

$sFilename = ($i==3) ? '../data/implementation_data.csv' : '../data/effective_data.csv';
...
$sTitle = ($i==3) ? $csv->data[$i]['Implementation'] : $csv->data[$i]['Effectiveness'];
